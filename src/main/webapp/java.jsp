...
<body id="page-top">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form id="examForm" action="javaresult.jsp" method="post">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".nextAndSelect").click(function() {
                ...
                $.ajax({
                    url: "submitAnswer.jsp", // Change this to the name of your JSP file
                    type: "POST",
            ...
            $(".submitAnswer").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // Handle success response if needed
                        window.location.href = "javaresult.jsp"; // Redirect to javaresult.jsp after submitting
                    },
                    error: function(xhr, status, error) {
                        console.error(xhr.responseText);
                    }
