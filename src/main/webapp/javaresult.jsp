    ...
    <script>
        $(document).ready(function() {
            ...
            $("#homeButton").click(function(e) {
                ...
                $.ajax({
                    url: "truncateUserAnswers.jsp", // Change this to the appropriate URL
                    type: "POST",
...
<body id="page-top">
                ...
                <div id="resultContainer">
                    <table style="border: 1px solid black;">
                        ...
                        <%          
                                ...
                                String answerQuery = "SELECT * FROM user_answers";
    ...
    <%
        ...
        try {
            ...
            String truncateQuery = "TRUNCATE TABLE user_answers";
            stmt.executeUpdate(truncateQuery);
            stmt.close();
            conn.close();
        } catch (SQLException e) {
            out.println("Error truncating user_answers table: " + e.getMessage());
            e.printStackTrace();
        }
    %>
</body>
